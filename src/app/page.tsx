...
export default function Home() {
  ...
  const skipHolidayClasses = appSettings.skipHolidayClasses;
  const setSkipHolidayClasses = useCallback((next: boolean) => {
    setAppSettings((prev) => ({ ...prev, skipHolidayClasses: next }));
  }, []);
